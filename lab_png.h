...
void get_png_data_IHDR(const char *filename, struct data_IHDR *out, FILE *fp, long offset, int whence); // extract from file the data field of the IHDR chunk, to populate a struct data_IHDR
